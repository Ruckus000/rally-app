...
>
> It's called Rally. Every Monday you stake a few goals on the week, and the
...
> other, close the week Sunday. No ads, no data collection, no upsell.
>
> Would you be open to a "Rally week" in the server: I set up a circle for
> anyone here who wants in, post the code in the check-in channel once, and
> at the end of the week post the ledger back? If it's not useful to your
...
> reaches your phone.
>
> So Rally does that. Monday you stake a few goals. Your circle sees them.
...
> the "did you write this week?" text you're already sending each other, minus
> the sending. Free, no ads, one code to join. Happy to set up the circle for
> you.
...
> The chat is where you talk about it. Rally is where it counts.
